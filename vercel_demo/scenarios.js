export const SCENARIOS = {
  database: {
    ...
    cloudWatchLogGroup: "/aws/ecs/payment-service",
    cloudWatchStreamPrefix: "demo-db",
  ...
  memory: {
    ...
    awsRegion: "us-east-1",
    awsAccountId: "123456789012",
    cloudWatchLogGroup: "/aws/ecs/inventory-service",
    cloudWatchStreamPrefix: "demo-oom",
    ...
    evaluationPeriods: 2,
    dimensions: [
      { name: "ServiceName", value: "inventory-service" },
      { name: "Environment", value: "production" },
    ],
    evidence: [
  ...
  deploy: {
    ...
    awsRegion: "us-east-1",
    awsAccountId: "123456789012",
    cloudWatchLogGroup: "/aws/ecs/checkout-service",
    cloudWatchStreamPrefix: "demo-http500",
    metricNamespace: "AWS/ApplicationELB",
  ...
  recovery: {
    ...
    awsRegion: "us-east-1",
    awsAccountId: "123456789012",
    cloudWatchLogGroup: "/aws/ecs/billing-service",
    cloudWatchStreamPrefix: "demo-recovery",
    metricNamespace: "AWS/ApplicationELB",
    metricName: "HTTPCode_Target_5XX_Count",
    metricUnit: "Count",
    threshold: 10,
    ...
    evaluationPeriods: 1,
    dimensions: [
      { name: "ServiceName", value: "billing-service" },
      { name: "Environment", value: "production" },
    ],
    evidence: [
